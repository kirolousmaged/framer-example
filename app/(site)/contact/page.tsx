...
const contactDetails = [
  ...
  {
    label: 'Address',
    value: '1234 Main Street, Suite 500\nLos Angeles, CA 90015',
    href: null,
    icon: (
      <svg
        width="18"
                  ...
                  <li key={item.label} className="flex items-start gap-4">
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      {item.href ? (
                        <a
                          href={item.href}
                          className="font-raleway text-sm text-off-black/70 hover:text-accent transition-colors whitespace-pre-line"
                        >
                          {item.value}
                        </a>
                      ) : (
                        <span className="font-raleway text-sm text-off-black/70 whitespace-pre-line">
                          {item.value}
                        </span>
                      )}
                    </div>
