        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-12">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3 max-w-xs">
              ...
              <p className="font-montserrat text-sm text-off-black/70 leading-relaxed">
                Get exclusive real estate insights, market trends, and property updates straight to
                your inbox.
              </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
            {[
              ...
              { heading: 'Utility', links: utilityLinks },
            ].map(({ heading, links }) => (
              <div key={heading} className="flex flex-col gap-4">
                <h5 className="font-montserrat font-semibold text-sm text-off-black uppercase tracking-wider">
                  {heading}
                </h5>
                <ul className="flex flex-col gap-2.5">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="font-montserrat text-sm text-off-black/70 hover:text-accent transition-colors duration-200"
                      >
                        {link.label}
                      </Link>
                    </li>
        ...
        <div className="border-t border-gray-100 pt-8 mb-8">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-8">
            <a
              ...
              className="inline-flex items-center gap-2 font-montserrat text-sm text-off-black/70 hover:text-accent transition-colors"
            >
            ...
            <span className="inline-flex items-center gap-2 font-montserrat text-sm text-off-black/70">
              ...
              1234 Main Street, Suite 500 Los Angeles, CA 90015
            </span>
          </div>
        </div>
